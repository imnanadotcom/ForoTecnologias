...
const Post = ({
  ...
  // Llamar a checkIfLiked cuando el componente se monte
  useEffect(() => {
    checkIfLiked();
    ...
    <div className="post">
      ...
      <div className="buttons-container">
        <div className="like-container">
          <button
            className={`btn-label ${isLiked ? "liked" : ""}`}
            onClick={handleLike}
          >
